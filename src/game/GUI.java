...
//		server.start();
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        ImageView imgCardBack1 = new ImageView(new Image(new FileInputStream("card/b1fv.png")));
        ImageView imgCardBack2 = new ImageView(new Image(new FileInputStream("card/b1fv.png")));
        ImageView imgCardBack3 = new ImageView(new Image(new FileInputStream("card/b1fv.png")));
            ...
            try {
                switch (cbCardValues.getValue()) {
                    case "Ace":
                        ...
                        break;
                    case "Jack":
                        imgCard.setImage(new Image(new FileInputStream("card/11.png")));
                        break;
                    case "Queen":
                        imgCard.setImage(new Image(new FileInputStream("card/12.png")));
                        break;
                    case "King":
                        imgCard.setImage(new Image(new FileInputStream("card/13.png")));
                        break;
                    default:
        ...
        btConfirmAction.setOnAction(e ->
        {
            ...
            for (int i = 1; i < 6; i++) {
                ...
                try {
                    userCard.setImage(new Image(new FileInputStream("card/" + i + ".png")));
                } catch (Exception ex) {
                    ex.printStackTrace();
                    System.out.print("Image not Found");
                }
